    ...
    <div className="bg-[#020617] mt-16 md:mt-32 text-slate-200 font-sans antialiased selection:bg-red-600 selection:text-white overflow-x-hidden">
      ...
      <section className="relative h-[70vh] md:h-[85vh] flex items-center justify-center overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="https://images.unsplash.com/photo-1592838064575-70ed626d3a0e?q=80&w=2000"
            className="w-full h-full object-cover"
            alt="FTL Heavy Logistics"
          />
        </div>
      ...
      {/* --- SECTION 2: WHAT IS FULL TRUCKLOAD? --- */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="grid gap-4 md:gap-6">
                {[
                  {
                    title: "Direct Point-to-Point",
                    desc: "No transshipment, reducing transit time and risk of damage.",
                  },
                  {
                    title: "Custom Fleet Options",
                    desc: "Choose from 20ft, 32ft MXL, Flatbeds, or specialized trailers.",
                  },
                  {
                    title: "Corporate SLA Guarantee",
                    desc: "Contracted uptime and placement guarantee for bulk movers.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
            ...
            <div data-aos="fade-left" className="relative group w-full">
      ...
      <section className="py-16 md:py-32 bg-slate-50 text-[#020617]">
        ...
        <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <SpecCard
            icon={<Anchor size={30} />}
            title="Heavy Haulage"
            desc="Capacity to move industrial raw materials, large machinery, and oversized cargo."
          />
          <SpecCard
            icon={<ShieldAlert size={30} />}
            title="Premium Security"
            desc="Tamper-proof seals and GPS-locked geofencing for high-value FTL loads."
          />
          <SpecCard
            icon={<Truck size={30} />}
            title="National Permit"
            desc="Seamless pan-India transit with pre-cleared toll and state boundary protocols."
          />
        </div>
      </section>
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-7" data-aos="fade-up">
            ...
            <div className="space-y-2">
              <FAQItem
                question="Which truck sizes do you provide?"
                answer="We offer 14ft, 17ft, 19ft, 20ft, 24ft, and 32ft (Single/Multi-Axle) trucks along with specialized trailers."
              />
              <FAQItem
                question="Is FTL faster than PTL?"
                answer="Yes, FTL is significantly faster as there are no hub-stops or cargo consolidation; it's a direct pickup and drop."
              />
              <FAQItem
                question="Can I book multiple trucks for a project?"
                answer="Absolutely. Localmate specializes in project-based logistics for factory relocations and mass inventory shifts."
              />
              <FAQItem
                question="Are the vehicles GPS tracked?"
                answer="Every FTL deployment is equipped with real-time GPS telemetry and a digital dashboard for the shipper."
              />
              <FAQItem
                question="What industries do you serve?"
                answer="We serve FMCG, Automobile, Pharma, Infrastructure, and E-commerce fulfillment sectors."
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-4 md:space-y-6">
              <ContactInfo
                ...
                text="Industrial Zone Hub, Sector 18, Gurgaon, India"
              />
              <ContactInfo
                icon={<Phone size={16} className="text-red-600" />}
                text="+91 4500 1122 33"
              />
              <ContactInfo
                icon={<Mail size={16} className="text-red-600" />}
                text="ftl.ops@localmate.com"
              />
            </div>
