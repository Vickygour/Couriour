          ...
          >
            ...
            <div className="space-y-4 md:space-y-6">
              <ContactInfo
                ...
                text="Local Node 04, Central Market, New Delhi"
              />
              <ContactInfo
                icon={<Phone size={16} className="text-red-600" />}
                text="+91 4500 3344 55"
              />
              <ContactInfo
                icon={<Mail size={16} className="text-red-600" />}
                text="instant@localmate.com"
              />
            </div>
            <button className="mt-8 md:mt-12 w-full bg-red-600 text-white py-4 md:py-5 rounded-xl md:rounded-2xl font-black uppercase italic tracking-widest text-[10px] hover:bg-white hover:text-black transition-all shadow-xl">
      ...
      <section className="bg-[#020617] py-16 md:py-24">
        <div className="container mx-auto px-6 text-center mb-12 md:mb-20">
          <h2 className="text-4xl md:text-8xl font-black uppercase tracking-tighter text-white">
            Initialize{" "}
            <span className="text-red-600 italic underline decoration-white/10">
              Dispatch.
            </span>
          </h2>
          <p className="text-slate-500 font-bold uppercase tracking-[0.3em] md:tracking-[0.5em] text-[8px] md:text-[10px] mt-4 opacity-60 italic">
            Intra-City Courier Uplink // Bharat Grid v2.0
          </p>
        </div>
